...
namespace ZHAW.SoftwareProjekt.Fractals.DataStructures.Tests
{
    ...
    public class BigFloatTests
    {
        ...
        public void BigFloat_Division_7()
        {
            ...
            BigFloat r = bd1 / bd2;
            Assert.AreEqual("0.50234482758618957432", r.ToString(), "BigFloat_Division_7 --> fehlerhaft");
        }
        ...
        public void BigFloat_Kombiniert_4()
        {
            ...
            Assert.AreEqual("12356789.987654321", r.ToString(), "BigFloat_Kombiniert_4 --> fehlerhaft");
        }
        ...
        public void BigFloat_Sqrt_2()
        {
            ...
            BigFloat r = BigFloat.Sqrt(bd);
            Assert.AreEqual("11.09610097236862746818", r.ToString(), "BigFloat_Sqrt_2 --> fehlerhaft");
        }
        ...
        [TestMethod]
        public void BigFloat_Sqrt_5()
        {
            BigFloat.MaxGenauigkeit = 20;
            BigFloat bd = 0;
            BigFloat r = BigFloat.Sqrt(bd);
            Assert.AreEqual("0", r.ToString(), "BigFloat_Sqrt_5 --> fehlerhaft");
        }
