...
namespace ZHAW.SoftwareProjekt.Fractals.DataStructures.Tests
{
    ...
    public class BigFloatTests
    {
        ...
        {
            BigFloat.MaxGenauigkeit = 1000;
            BigFloat bd = "33108105160601331081051606013904390411.096100972368627468175859791090330007720832711696802116109361236089261718398367441573520422490841183237199633926171875";
            BigFloat r = BigFloat.Sqrt(bd);
            for (int i = 0; i < 99; i++)
            {
                bd = "33108105160601331081051606013904390411.096100972368627468175859791090330007720832711696802116109361236089261718398367441573520422490841183237199633926171875";
                r = BigFloat.Sqrt(bd);
            }
